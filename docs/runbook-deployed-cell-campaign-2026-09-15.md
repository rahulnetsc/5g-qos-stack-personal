# Runbook: the five-arm guarantee campaign on the deployed cell, on a fresh Linux machine

Written 2026-09-15. Everything needed is on branch `feat/high-fidelity-sim`
at or after commit `91a7e6a`. The campaign measures the ten guarantees
