...
| **G10** | PF 30/40 · Res 23/40 · TT 26/40 (per-N: 8 / 4 / 4) | **NO** | **M-6 (binds harder as N grows — N is this clause's axis)**, M-9, **P1-1's load-dependent control-plane cost** | N ∈ {10, 12}; and it scores **1 of 8** sub-clauses |
