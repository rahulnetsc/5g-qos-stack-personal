...
3 (the GBR-deficit/PDB-remaining sort tiers), and 3a (the windowed-
ceiling VQ itself, replacing the bootstrap PF coefficient in both
directions) have now landed — see this table's own row 1/row 2/row 3/
row 3a entries above for what each did and confirmed; commits 4-9 not
