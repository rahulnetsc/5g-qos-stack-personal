...
not just asserted. Next: commit 9 (OLLA's ratchet, D2(b)) — the
commit that removes the SECOND of those two reasons, not the first;
score its own prediction against that distinction specifically, not
against "commit 8 was inert so commit 9 should be too."
