...
| **G12** (**⚠ WITHDRAWN 2026-09-08: every order here is an artefact of the GBR offered-shortfall; see `docs/g12-slide-source.md` §4**) | TwoTier `[4,2]` 5/10, `[2,4]` 4/10, one degenerate `[2]` | **TwoTier's counts move; PF's `[4,2]` 10/10 MUST NOT** | first-violation order is order-sensitive by construction |
